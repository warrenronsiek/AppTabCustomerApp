...
let url, stripePublicKey, firehoseName, identityPoolId, identityPoolName, apiKey;
if (__DEV__) {
...
export {url, stripePublicKey, firehoseName, identityPoolId, identityPoolName, apiKey}